        ...
        function render() {
            ...
            if (sections) {
                ...
                var tmp_Search = $("<td/>").append(
                    ...
                    "<img alt='Search Reset'  id='reserButton' onclick=\"$('#searchInput').val('');$('#searchInput').keyup();\" src='images/reset_b.svg'  />" + "</div>"
                );
                ...
                tmp_Left.find('#ButtonMsg')
                    ...
                    .click(function () {
                        if ($('#invitationEventBox').css('display') === 'none') {
                            $('#invitationEventBox').css('display', 'block');
                            $('.ezz').css('z-index', 25);
                        } 
                    });
    ...
    function AgendaEventRenderer () {
        ...
        function setTimeIndicator() {
            ...
            if (curtime.length==0 || todaytimeline.length==0) { 
                ...
                // console.log("tmp_mins is", tmp_mins);
                curtime = $('<div>')

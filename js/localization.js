...
localization['zh_CN']=	/* @steve <stevesasuke@gmail.com> */
{
	txtResources: '资源',
	txtNote: '备注',

	errUnableSync: '错误: \'无法同步资源\': 稍后重试!',

	loadingResources: '读取资源 (%act% of %total%) ...',
	loadingCollectionList: '读取资源列表',

	txtCacheText: '服务器上有一个可用的更新，请重新加载页面!',
	txtCacheButton: '重新加载'
};
...
localizationShared['zh_CN']=	/* @steve <stevesasuke@gmail.com> */
{
	_name_: '中文',
	_default_datepicker_format_: 'yy-mm-dd',
	_default_AMPM_format_: true,
	...
	errCollectionLoad: '错误: \'无法保存设定\'!',
	errHttpCommon: '错误代码 %%',
	errHttp401: '未授权',
	errHttp403: '禁止',
	errHttp405: '未允许的方法',
	errHttp408: '请求超时',
	errHttp412: '服务器上他人已改变该项目',
	errHttp500: '内部服务错误',
	errHttp501: '没有实现',

	unsupportedBrowser: '注意: 暂不支持您的浏览器!',
	updateNotification: '%name% %new_ver% 可用 (您有 %curr_ver%) - %url%'
};
...
localizationSharedCalDAV['zh_CN']=	/* @steve <stevesasuke@gmail.com> */
{
	txtCalendars: '日历',
	txtTodos: '待办',
	localTime: '当地时间',
	fullCalendarMonth: '月',
	//ullCalendarMultiWeek: 'mweek',
...
localizationCalDAV['zh_CN']=	/* @steve <stevesasuke@gmail.com> */
{
	_default_title_format_month_: 'yyyy 年 MMM',
	_default_title_format_week_: 'yyyy 年 MMM d 日{ \'–\'[ yyyy ][ MMM] d 日}',
	_default_title_format_day_: 'yyyy 年 MMM d 日  dddd',
	_default_title_format_table_: 'MMM d 日   dddd',
	_default_column_format_agenda_: 'ddd',

	txtCalendar: '日历',
	txtEnabledCalendars: '使用的日历',
	txtTodo: '待办',
	txtTodoList: '待办列表',
	txtTodoLists: '待办列表',
	txtEnabledTodoLists: '使用的待办列表',
	txtSubscribed: '订阅？',
	fullCalendarTable: '表格',
	fullCalendarTodayButton: '前往今天',
	fullCalendarAllDay: '全天',
	CalDAVsearch: '搜索',
	resourceEnable: '在此资源中使用所有日历',
	resourceDisable: '在此资源中不使用所有日历',
	allEnable: '使用所有日历',
	allDisable: '不使用所有日历',
	timezone: '时区',
	...
	loadingRList: '读取资源列表 ...',
	renderingE: '渲染日历 ...',
	timezoneChange: '应用时区设置 ...',
	customTimezone: '自定义 (当地时间)',
	loadPrevMonth: '读取前一个月',
	loadNextMonth: '读取下一个月',
	repeatBoxButton: '更改重复事件？',
	repeatBoxContent: '是一个重复事件',
	// repeatBoxQuestion: '如果修改，哪些事件跟着一起修改？',
	repeatBoxQuestion: '你正在更改重复事件，你想仅更改此事件还是一并更改未来所有的重复事件?',
	allEvsButton: '所有事件',
	allFutureButton: '当前事件及将来',
	eventOnlyButton: '仅此事件',
	repeatBoxContentTODO: '是一个重复的待办',
	repeatBoxQuestionTODO: '如果修改，哪些事件跟着一起修改？',
	allEvsButtonTODO: '所有待办',
	allFutureButtonTODO: '当前和所有未来待办',
	eventOnlyButtonTODO: '仅当前待办',
	txtStatus: '状态',
	eventAvailability : '空闲程度',
	...
	repeatMonths: '月',
	repeatYears: '年',
	repeatChangeTxt: '已在服务器中被更新',
	repeatChangeTxtClose: '关闭表格并再次打开事件',
	repeatTodoChangeTxtClose: '关闭表格并再次打开待办',
	calendarLoader: '重新加载 ...',
	resizeLoader: '重新恢复尺寸 ...',
	...
	txtStatusNone: '未指明的',
	txtStatusTentative: '不确定的',
	txtStatusConfirmed: '确定的',
	txtStatusCancelled: '取消的',

	txtRepeat: '重复',
	txtNoRepeat: '永不',
	txtRepeatDay: '每天',
	txtRepeatWeek: '每周',
	txtRepeatWeekend: '每个周末',
	txtRepeatMonth: '每个月',
	txtRepeatTwoWeek: '每两周',
	txtRepeatYear: '每年',
	txtRepeatCustomWeek: '自定义每周',
	txtRepeatCustomMonth: '自定义每月',
	txtRepeatCustomYear: '自定义每年',
	txtRepeatWork: '每个工作日',
	txtRepeatOnDate: '日期',
	txtRepeatAfter: '发生次数',
	txtRepeatNever: '从不',
	pholderUntilDate: '直到该日期',
	pholderRepeatCount: '重复次数',
	txtRepeatCustomWeekLabel: '在',
	txtRepeatCustomMonthLabel: '在这些天',
	txtRepeatCustomMonthEvery: '每',
	txtRepeatCustomMonthFirst: '第一个',
	txtRepeatCustomMonthSecond: '第二个',
	txtRepeatCustomMonthThird: '第三个',
	txtRepeatCustomMonthFourth: '第四个',
	txtRepeatCustomMonthFifth: '第五个',
	txtRepeatCustomMonthLast: '最后一个',
	txtRepeatCustomMonthCustom: '自定义',
	txtRepeatCustomMonthMonth: '日子',
	txtRepeatCustomYearLabel1: '每',
	txtRepeatCustomYearLabel2: '在',

	txtRepeatEnd: '结束',
	txtEventCalendar: '日历',
	txtSelectCalendar: '选择一个日历',
	txtAlert: '提醒',
	txtAlertNone: '无',
	txtAlertMessage: '信息',
	txtAlertOnDate: '日期',
	txtAlertWeeksBefore: '星期前',
	txtAlertDaysBefore: '天前',
	txtAlertHoursBefore: '小时前',
	txtAlertMinutesBefore: '分钟前',
	txtAlertSecondsBefore: '秒前',
	txtAlertWeeksAfter: '星期后',
	txtAlertDaysAfter: '天后',
	txtAlertHoursAfter: '小时后',
	txtAlertMinutesAfter: '分钟后',
	txtAlertSecondsAfter: '秒后',
	...
	txtAllSavedTodo: '成功: Todo Saved!',
	txtAllSaved: '成功: 事件成功保存！',

	txtAllDeletedTodo: 'Success: Todo Deleted!',
	txtAllDeleted: '成功: 事件成功删除！',

	txtNotChooseTodo: 'Error: Have to choose calendar!',
	txtNotChoose: '错误: 必须选择一个日历！',

	txtErrorDates: 'Error: Start date must precede the end date!',
	txtErrorDatesTodo: '错误: 开始日期必须早于结束日期！',

	txtErorInputTodo: 'Unable to save: correct invalid values!',
	txtDateTimeErrorTodo: '必须选择日期和时间',

	txtErorInput: '错误: \'无法保存\': 请更正高亮的非法值！',
	...
	loadingCalendars: '加载日历 (%act% of %total%) ...',
	unloadingCalendars: '解除日历 ...',

	errUnableSaveBeginCalDAV: '错误: \'无法保存事件\': %%!',
	errUnableDeleteBeginCalDAV: '错误: \'无法删除事件\': %%!',
	CalDAVerrHttp410: '该事件在服务器上已无法获取',
	errUnableSaveTodoBeginCalDAV: '错误: \'unable to save the todo\': %%!',
	errUnableDeleteTodoBeginCalDAV: '错误: \'unable to delete todo\': %%!',
	CalDAVerrTodoHttp410: 'Todo is no longer available at the server'
};
